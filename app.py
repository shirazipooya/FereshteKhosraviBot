...
async def send_fengshui_question(user_id):
    ...
    if idx < len(POLL_QUESTIONS):
        ...
        await bot.send_message(
            chat_id=user_id,
            text=(
                "در صورتیکه میخوای خودم به صورت حضوری یا آنلاین فنگشویی خونت رو انجام بدم و فرکانس خونت و انرژی محیطتت رو بالا ببری 👇🏼\n\n"
                "✅فنگشویی حضوری :\n"
                "متری ۲۵۰ هزار تومان\n\n"
                "💚فنگشویی به صورت آنلاین :\n"
                "متری ۱۵۰ هزار تومان \n\n"
                "💡مثال\n"
                "فنگشویی یک خانه ۱۰۰ متری\n"
                "آنلاین ۲۰ میلیون تومان و\n"
                "حضوری ۲۵ میلیون تومان\n\n"
                "برای رزرو به آیدی زیر پیام بدید\n"
                "@fereshtehelp\n"
                "یا با شماره\n"
                "09364998675\n"
                "تماس بگیرید.\n\n"
                "اگر میخوای برای سال جدید یک خونه تکونی ثروتساز انجام بدی و فرکانس خونت رو بالا ببری تا جذب کننده پول و ثروت و فراوانی باشی. میتونی توی دوره رایگان من به اسم «خونه تکونی ثروتساز» شرکت کنی.\n\n"
                "ارزش این دوره ۴ میلیون هستش که برای ۱۰ هزار نفر رایگان شده.\n\n"
                "برای شرکت توی این دوره روی لینک زیر بزن 👇🏼\n\n"
                "https://t.me/norozfereshte\n"
            ),
            reply_markup=markup,
            parse_mode="HTML"
        )
